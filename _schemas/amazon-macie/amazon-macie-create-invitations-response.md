...
schema_file: json-schema/amazon-macie-create-invitations-response-schema.json
slug: amazon-macie-create-invitations-response
source_filename: amazon-macie-create-invitations-response-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-macie/refs/heads/main/json-schema/amazon-macie-create-invitations-response-schema.json
tags:
- Data Security
- Sensitive Data
- Privacy
