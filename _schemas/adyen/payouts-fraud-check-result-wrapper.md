...
provider_name: Adyen
provider_slug: adyen
schema_file: json-schema/payouts-fraud-check-result-wrapper-schema.json
slug: payouts-fraud-check-result-wrapper
source_filename: payouts-fraud-check-result-wrapper-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/adyen/refs/heads/main/json-schema/payouts-fraud-check-result-wrapper-schema.json
tags:
- Payments
- Financial Services
- Fintech
