...
schema_file: json-schema/update-landing-zone-response-schema.json
slug: update-landing-zone-response
source_filename: update-landing-zone-response-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-control-tower/refs/heads/main/json-schema/update-landing-zone-response-schema.json
tags:
- AWS
- Compliance
- Governance
