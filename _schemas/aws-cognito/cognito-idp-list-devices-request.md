...
schema_file: json-schema/cognito-idp-list-devices-request-schema.json
slug: cognito-idp-list-devices-request
source_filename: cognito-idp-list-devices-request-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/aws-cognito/refs/heads/main/json-schema/cognito-idp-list-devices-request-schema.json
tags:
- Authentication
- Authorization
- AWS
