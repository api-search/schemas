---
description: StoredValueLoadResponse schema from Adyen API
layout: schema
...
provider_name: Adyen
provider_slug: adyen
schema_file: json-schema/stored-value-stored-value-load-response-schema.json
slug: stored-value-stored-value-load-response
source_filename: stored-value-stored-value-load-response-schema.json
source_heading: JSON Schema
source_json: "{\n  \"$schema\": \"https://json-schema.org/draft/2020-12/schema\",\n  \"$id\": \"https://raw.githubusercontent.com/api-evangelist/adyen/refs/heads/main/json-schema/stored-value-stored-value-load-response-schema.json\",\n  \"title\": \"StoredValueLoadResponse\",\n  \"description\": \"StoredValueLoadResponse schema from Adyen API\",\n  \"type\": \"object\",\n  \"properties\": {\n    \"authCode\": {\n      \"description\": \"Authorisation code:\\n* When the payment is authorised, this field holds the authorisation code for the payment.\\n* When the payment is not authorised, this field is empty.\",\n      \"type\": \"string\"\n    },\n    \"currentBalance\": {\n      \"description\": \"The balance currently on the payment method.\",\n      \"$ref\": \"#/components/schemas/Amount\"\n    },\n    \"pspReference\": {\n      \"description\": \"Adyen's 16-character string reference associated with the transaction/request. This value is globally unique; quote it when communicating with\
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/adyen/refs/heads/main/json-schema/stored-value-stored-value-load-response-schema.json
tags:
- Payments
- Financial Services
- Fintech
