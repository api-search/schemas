...
schema_file: json-schema/user-pools-create-user-pool-domain-request-schema.json
slug: user-pools-create-user-pool-domain-request
source_filename: user-pools-create-user-pool-domain-request-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-cognito/refs/heads/main/json-schema/user-pools-create-user-pool-domain-request-schema.json
tags:
- Authentication
- Identity
- OAuth
