...
provider_name: Adyen
provider_slug: adyen
schema_file: json-schema/payments-capture-request-schema.json
slug: payments-capture-request
source_filename: payments-capture-request-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/adyen/refs/heads/main/json-schema/payments-capture-request-schema.json
tags:
- Payments
- Financial Services
- Fintech
