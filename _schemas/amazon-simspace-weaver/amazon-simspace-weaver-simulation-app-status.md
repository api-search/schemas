...
schema_file: json-schema/amazon-simspace-weaver-simulation-app-status-schema.json
slug: amazon-simspace-weaver-simulation-app-status
source_filename: amazon-simspace-weaver-simulation-app-status-schema.json
