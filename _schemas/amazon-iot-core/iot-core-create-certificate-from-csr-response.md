...
schema_file: json-schema/iot-core-create-certificate-from-csr-response-schema.json
slug: iot-core-create-certificate-from-csr-response
source_filename: iot-core-create-certificate-from-csr-response-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-iot-core/refs/heads/main/json-schema/iot-core-create-certificate-from-csr-response-schema.json
tags:
- Device Management
- IoT
- MQTT
