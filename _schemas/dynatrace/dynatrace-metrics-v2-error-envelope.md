...
schema_file: json-schema/dynatrace-metrics-v2-error-envelope-schema.json
slug: dynatrace-metrics-v2-error-envelope
source_filename: dynatrace-metrics-v2-error-envelope-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/dynatrace/refs/heads/main/json-schema/dynatrace-metrics-v2-error-envelope-schema.json
tags:
- AI Operations
- Analytics
- APM
