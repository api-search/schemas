...
provider_name: Adyen
provider_slug: adyen
schema_file: json-schema/notification-webhooks-transaction-event-violation-schema.json
slug: notification-webhooks-transaction-event-violation
source_filename: notification-webhooks-transaction-event-violation-schema.json
source_heading: JSON Schema
source_json: "{\n  \"$schema\": \"https://json-schema.org/draft/2020-12/schema\",\n  \"$id\": \"https://raw.githubusercontent.com/api-evangelist/adyen/refs/heads/main/json-schema/notification-webhooks-transaction-event-violation-schema.json\",\n  \"title\": \"TransactionEventViolation\",\n  \"description\": \"TransactionEventViolation schema from Adyen API\",\n  \"properties\": {\n    \"reason\": {\n      \"description\": \"An explanation about why the transaction rule failed.\",\n      \"type\": \"string\"\n    },\n    \"transactionRule\": {\n      \"description\": \"Contains information about the transaction rule.\",\n      \"$ref\": \"#/components/schemas/ResourceReference\"\n    },\n    \"transactionRuleSource\": {\n      \"description\": \"Contains the type and ID of the resource to which the transaction rule is linked.\",\n      \"$ref\": \"#/components/schemas/TransactionRuleSource\"\n    }\n  },\n  \"type\": \"object\"\n}"
source_json_url: https://raw.githubusercontent.com/api-evangelist/adyen/refs/heads/main/json-schema/notification-webhooks-transaction-event-violation-schema.json
tags:
- Payments
- Financial Services
- Fintech
