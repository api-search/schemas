...
schema_file: json-schema/iot-device-defender-describe-provisioning-template-response-schema.json
slug: iot-device-defender-describe-provisioning-template-response
source_filename: iot-device-defender-describe-provisioning-template-response-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-iot-device-defender/refs/heads/main/json-schema/iot-device-defender-describe-provisioning-template-response-schema.json
tags:
- AWS
- Compliance
- IoT
