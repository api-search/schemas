...
schema_file: json-schema/hubspot-crm-deals-batch-response-deal-schema.json
slug: hubspot-crm-deals-batch-response-deal
source_filename: hubspot-crm-deals-batch-response-deal-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/hubspot/refs/heads/main/json-schema/hubspot-crm-deals-batch-response-deal-schema.json
tags:
- Analytics
- Commerce
- Content
