...
schema_file: json-schema/user-pools-get-device-request-schema.json
slug: user-pools-get-device-request
source_filename: user-pools-get-device-request-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-cognito/refs/heads/main/json-schema/user-pools-get-device-request-schema.json
tags:
- Authentication
- Identity
- OAuth
