...
schema_file: json-schema/glue-create-workflow-response-schema.json
slug: glue-create-workflow-response
source_filename: glue-create-workflow-response-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-glue/refs/heads/main/json-schema/glue-create-workflow-response-schema.json
tags:
- Analytics
- Data Catalog
- Data Integration
