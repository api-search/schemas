...
schema_file: json-schema/cognito-idp-authentication-result-type-schema.json
slug: cognito-idp-authentication-result-type
source_filename: cognito-idp-authentication-result-type-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/aws-cognito/refs/heads/main/json-schema/cognito-idp-authentication-result-type-schema.json
tags:
- Authentication
- Authorization
- AWS
