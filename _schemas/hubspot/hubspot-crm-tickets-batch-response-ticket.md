...
schema_file: json-schema/hubspot-crm-tickets-batch-response-ticket-schema.json
slug: hubspot-crm-tickets-batch-response-ticket
source_filename: hubspot-crm-tickets-batch-response-ticket-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/hubspot/refs/heads/main/json-schema/hubspot-crm-tickets-batch-response-ticket-schema.json
tags:
- Analytics
- Commerce
- Content
