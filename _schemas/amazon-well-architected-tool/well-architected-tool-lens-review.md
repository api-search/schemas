...
schema_file: json-schema/well-architected-tool-lens-review-schema.json
slug: well-architected-tool-lens-review
source_filename: well-architected-tool-lens-review-schema.json
...
source_json: "{\n  \"type\": \"object\",\n  \"properties\": {\n    \"LensAlias\": {\n      \"$ref\": \"#/components/schemas/LensAlias\"\n    },\n    \"LensArn\": {\n      \"allOf\": [\n        {\n          \"$ref\": \"#/components/schemas/LensArn\"\n        },\n        {\n          \"description\": \"The ARN for the lens.\"\n        }\n      ]\n    },\n    \"LensVersion\": {\n      \"allOf\": [\n        {\n          \"$ref\": \"#/components/schemas/LensVersion\"\n        },\n        {\n          \"description\": \"The version of the lens.\"\n        }\n      ]\n    },\n    \"LensName\": {\n      \"$ref\": \"#/components/schemas/LensName\"\n    },\n    \"LensStatus\": {\n      \"allOf\": [\n        {\n          \"$ref\": \"#/components/schemas/LensStatus\"\n        },\n        {\n          \"description\": \"The status of the lens.\"\n        }\n      ]\n    },\n    \"PillarReviewSummaries\": {\n      \"$ref\": \"#/components/schemas/PillarReviewSummaries\"\n    },\n    \"UpdatedAt\": {\n\
  \      \"$ref\": \"#/components/schemas/Timestamp\"\n    },\n    \"Notes\": {\n      \"$ref\": \"#/components/schemas/Notes\"\n    },\n    \"RiskCounts\": {\n      \"$ref\": \"#/components/schemas/RiskCounts\"\n    },\n    \"NextToken\": {\n      \"$ref\": \"#/components/schemas/NextToken\"\n    },\n    \"Profiles\": {\n      \"allOf\": [\n        {\n          \"$ref\": \"#/components/schemas/WorkloadProfiles\"\n        },\n        {\n          \"description\": \"The profiles associated with the workload.\"\n        }\n      ]\n    },\n    \"PrioritizedRiskCounts\": {\n      \"$ref\": \"#/components/schemas/RiskCounts\"\n    }\n  },\n  \"description\": \"A lens review of a question.\",\n  \"$schema\": \"https://json-schema.org/draft/2020-12/schema\",\n  \"title\": \"LensReview\",\n  \"$id\": \"https://raw.githubusercontent.com/api-evangelist/amazon-well-architected-tool/refs/heads/main/json-schema/well-architected-tool-lens-review-schema.json\"\n}"
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-well-architected-tool/refs/heads/main/json-schema/well-architected-tool-lens-review-schema.json
tags:
- Architecture
- Best Practices
- Cloud Governance
