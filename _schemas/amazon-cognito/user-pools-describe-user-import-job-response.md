...
schema_file: json-schema/user-pools-describe-user-import-job-response-schema.json
slug: user-pools-describe-user-import-job-response
source_filename: user-pools-describe-user-import-job-response-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-cognito/refs/heads/main/json-schema/user-pools-describe-user-import-job-response-schema.json
tags:
- Authentication
- Identity
- OAuth
