---
description: GetMemberResponse schema from Amazon Macie API
layout: schema
...
schema_file: json-schema/amazon-macie-get-member-response-schema.json
slug: amazon-macie-get-member-response
source_filename: amazon-macie-get-member-response-schema.json
source_heading: JSON Schema
source_json: "{\n  \"$schema\": \"https://json-schema.org/draft/2020-12/schema\",\n  \"$id\": \"https://raw.githubusercontent.com/api-evangelist/amazon-macie/refs/heads/main/json-schema/amazon-macie-get-member-response-schema.json\",\n  \"title\": \"GetMemberResponse\",\n  \"description\": \"GetMemberResponse schema from Amazon Macie API\",\n  \"type\": \"object\",\n  \"properties\": {\n    \"accountId\": {\n      \"allOf\": [\n        {\n          \"$ref\": \"#/components/schemas/__string\"\n        },\n        {\n          \"description\": \"The Amazon Web Services account ID for the account.\"\n        }\n      ]\n    },\n    \"administratorAccountId\": {\n      \"allOf\": [\n        {\n          \"$ref\": \"#/components/schemas/__string\"\n        },\n        {\n          \"description\": \"The Amazon Web Services account ID for the administrator account.\"\n        }\n      ]\n    },\n    \"arn\": {\n      \"allOf\": [\n        {\n          \"$ref\": \"#/components/schemas/__string\"\
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-macie/refs/heads/main/json-schema/amazon-macie-get-member-response-schema.json
tags:
- AWS
- Data Security
- Sensitive Data
