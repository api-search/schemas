...
schema_file: json-schema/iot-device-defender-list-streams-response-schema.json
slug: iot-device-defender-list-streams-response
source_filename: iot-device-defender-list-streams-response-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-iot-device-defender/refs/heads/main/json-schema/iot-device-defender-list-streams-response-schema.json
tags:
- AWS
- Compliance
- IoT
