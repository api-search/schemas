...
schema_file: json-schema/mediapackage-api-create-origin-endpoint-response-schema.json
slug: mediapackage-api-create-origin-endpoint-response
source_filename: mediapackage-api-create-origin-endpoint-response-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-mediapackage/refs/heads/main/json-schema/mediapackage-api-create-origin-endpoint-response-schema.json
tags:
- AWS
- Broadcasting
- Media Processing
