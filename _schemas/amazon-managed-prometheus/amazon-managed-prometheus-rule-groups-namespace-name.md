...
schema_file: json-schema/amazon-managed-prometheus-rule-groups-namespace-name-schema.json
slug: amazon-managed-prometheus-rule-groups-namespace-name
source_filename: amazon-managed-prometheus-rule-groups-namespace-name-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-managed-prometheus/refs/heads/main/json-schema/amazon-managed-prometheus-rule-groups-namespace-name-schema.json
tags:
- AWS
- Containers
- Monitoring
