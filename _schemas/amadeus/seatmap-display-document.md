...
schema_file: json-schema/seatmap-display-document-schema.json
slug: seatmap-display-document
source_filename: seatmap-display-document-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amadeus/refs/heads/main/json-schema/seatmap-display-document-schema.json
tags:
- Airlines
- Aviation
- Booking
