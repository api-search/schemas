...
schema_file: json-schema/iot-device-management-create-dimension-response-schema.json
slug: iot-device-management-create-dimension-response
source_filename: iot-device-management-create-dimension-response-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-iot-device-management/refs/heads/main/json-schema/iot-device-management-create-dimension-response-schema.json
tags:
- Device Management
- Fleet Management
- IoT
