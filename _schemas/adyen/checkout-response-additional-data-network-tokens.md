...
provider_name: Adyen
provider_slug: adyen
schema_file: json-schema/checkout-response-additional-data-network-tokens-schema.json
slug: checkout-response-additional-data-network-tokens
source_filename: checkout-response-additional-data-network-tokens-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/adyen/refs/heads/main/json-schema/checkout-response-additional-data-network-tokens-schema.json
tags:
- Payments
- Financial Services
- Fintech
