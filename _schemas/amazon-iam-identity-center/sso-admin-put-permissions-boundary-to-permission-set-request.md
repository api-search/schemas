...
schema_file: json-schema/sso-admin-put-permissions-boundary-to-permission-set-request-schema.json
slug: sso-admin-put-permissions-boundary-to-permission-set-request
source_filename: sso-admin-put-permissions-boundary-to-permission-set-request-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-iam-identity-center/refs/heads/main/json-schema/sso-admin-put-permissions-boundary-to-permission-set-request-schema.json
tags:
- Access Control
- Authentication
- Identity Management
