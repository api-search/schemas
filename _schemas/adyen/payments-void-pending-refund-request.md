---
description: VoidPendingRefundRequest schema from Adyen API
layout: schema
...
- description: The merchant account that is used to process the payment.
  ...
  type: string
- description: The amount that needs to be captured/refunded. Required for `/capture` and `/refund`, not allowed for `/cancel`. The `currency` must match the currency used in authorisation, the `value` must be small
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/adyen/refs/heads/main/json-schema/payments-void-pending-refund-request-schema.json
tags:
- Payments
- Financial Services
- Fintech
