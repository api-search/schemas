...
schema_file: json-schema/gamelift-describe-fleet-port-settings-output-schema.json
slug: gamelift-describe-fleet-port-settings-output
source_filename: gamelift-describe-fleet-port-settings-output-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-gamelift/refs/heads/main/json-schema/gamelift-describe-fleet-port-settings-output-schema.json
tags:
- AWS
- Cloud Computing
- Game Servers
