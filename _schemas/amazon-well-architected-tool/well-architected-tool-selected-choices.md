...
schema_file: json-schema/well-architected-tool-selected-choices-schema.json
slug: well-architected-tool-selected-choices
source_filename: well-architected-tool-selected-choices-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-well-architected-tool/refs/heads/main/json-schema/well-architected-tool-selected-choices-schema.json
tags:
- Architecture
- Best Practices
- Cloud Governance
