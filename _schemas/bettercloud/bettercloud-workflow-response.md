...
schema_file: json-schema/bettercloud-workflow-response-schema.json
slug: bettercloud-workflow-response
source_filename: bettercloud-workflow-response-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/bettercloud/refs/heads/main/json-schema/bettercloud-workflow-response-schema.json
tags:
- Automation
- Compliance
- Enterprise
