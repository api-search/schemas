...
source_filename: dynatrace-entities-v2-entity-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/dynatrace/refs/heads/main/json-schema/dynatrace-entities-v2-entity-schema.json
tags:
- AI Operations
- Analytics
- APM
