...
schema_file: json-schema/well-architected-tool-workload-name-schema.json
slug: well-architected-tool-workload-name
source_filename: well-architected-tool-workload-name-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-well-architected-tool/refs/heads/main/json-schema/well-architected-tool-workload-name-schema.json
tags:
- Architecture
- Best Practices
- Cloud Governance
