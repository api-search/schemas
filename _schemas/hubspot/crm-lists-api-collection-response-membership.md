...
schema_file: json-schema/crm-lists-api-collection-response-membership-schema.json
slug: crm-lists-api-collection-response-membership
source_filename: crm-lists-api-collection-response-membership-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/hubspot/refs/heads/main/json-schema/crm-lists-api-collection-response-membership-schema.json
tags:
- Analytics
- Commerce
- Content
