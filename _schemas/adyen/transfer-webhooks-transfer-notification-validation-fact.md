...
provider_name: Adyen
provider_slug: adyen
schema_file: json-schema/transfer-webhooks-transfer-notification-validation-fact-schema.json
slug: transfer-webhooks-transfer-notification-validation-fact
source_filename: transfer-webhooks-transfer-notification-validation-fact-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/adyen/refs/heads/main/json-schema/transfer-webhooks-transfer-notification-validation-fact-schema.json
tags:
- Payments
- Financial Services
- Fintech
