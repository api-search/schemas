...
schema_file: json-schema/cognito-idp-create-user-pool-client-request-schema.json
slug: cognito-idp-create-user-pool-client-request
source_filename: cognito-idp-create-user-pool-client-request-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/aws-cognito/refs/heads/main/json-schema/cognito-idp-create-user-pool-client-request-schema.json
tags:
- Authentication
- Authorization
- Identity
