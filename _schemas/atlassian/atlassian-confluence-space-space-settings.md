...
schema_file: json-schema/atlassian-confluence-space-space-settings-schema.json
slug: atlassian-confluence-space-space-settings
source_filename: atlassian-confluence-space-space-settings-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/atlassian/refs/heads/main/json-schema/atlassian-confluence-space-space-settings-schema.json
tags:
- Code
- Collaboration
- Platform
