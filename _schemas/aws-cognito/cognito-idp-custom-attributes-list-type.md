---
description: CustomAttributesListType schema from Amazon Cognito
layout: schema
name: CustomAttributesListType
properties_list: []
provider_name: Amazon Cognito
provider_slug: aws-cognito
schema_file: json-schema/cognito-idp-custom-attributes-list-type-schema.json
slug: cognito-idp-custom-attributes-list-type
source_filename: cognito-idp-custom-attributes-list-type-schema.json
