...
schema_file: json-schema/application-migration-service-update-wave-request-schema.json
slug: application-migration-service-update-wave-request
source_filename: application-migration-service-update-wave-request-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-application-migration-service/refs/heads/main/json-schema/application-migration-service-update-wave-request-schema.json
tags:
