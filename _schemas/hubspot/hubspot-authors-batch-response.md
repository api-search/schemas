...
source_filename: hubspot-authors-batch-response-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/hubspot/refs/heads/main/json-schema/hubspot-authors-batch-response-schema.json
tags:
- Analytics
- Commerce
- Content
