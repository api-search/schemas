...
schema_file: json-schema/youtube-live-error-response-schema.json
slug: youtube-live-error-response
source_filename: youtube-live-error-response-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/youtube/refs/heads/main/json-schema/youtube-live-error-response-schema.json
tags:
- Google
- Media
- Social
