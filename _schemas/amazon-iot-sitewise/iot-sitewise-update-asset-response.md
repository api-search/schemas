...
schema_file: json-schema/iot-sitewise-update-asset-response-schema.json
slug: iot-sitewise-update-asset-response
source_filename: iot-sitewise-update-asset-response-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-iot-sitewise/refs/heads/main/json-schema/iot-sitewise-update-asset-response-schema.json
tags:
- Asset Management
- Industrial IoT
- IoT
