...
schema_file: json-schema/amazon-codeguru-security-list-scans-request-max-results-integer-schema.json
slug: amazon-codeguru-security-list-scans-request-max-results-integer
source_filename: amazon-codeguru-security-list-scans-request-max-results-integer-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-codeguru-security/refs/heads/main/json-schema/amazon-codeguru-security-list-scans-request-max-results-integer-schema.json
tags:
- Amazon
- AWS
- Security
