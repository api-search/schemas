...
schema_file: json-schema/hubspot-crm-lists-collection-response-membership-schema.json
slug: hubspot-crm-lists-collection-response-membership
source_filename: hubspot-crm-lists-collection-response-membership-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/hubspot/refs/heads/main/json-schema/hubspot-crm-lists-collection-response-membership-schema.json
tags:
- Analytics
- Commerce
- Content
