...
schema_file: json-schema/flight-create-orders-travelerpricingfareoption-schema.json
slug: flight-create-orders-travelerpricingfareoption
source_filename: flight-create-orders-travelerpricingfareoption-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amadeus/refs/heads/main/json-schema/flight-create-orders-travelerpricingfareoption-schema.json
tags:
- Airlines
- Aviation
- Booking
