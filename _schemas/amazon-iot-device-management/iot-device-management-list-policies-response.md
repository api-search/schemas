...
schema_file: json-schema/iot-device-management-list-policies-response-schema.json
slug: iot-device-management-list-policies-response
source_filename: iot-device-management-list-policies-response-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-iot-device-management/refs/heads/main/json-schema/iot-device-management-list-policies-response-schema.json
tags:
- Device Management
- Fleet Management
- IoT
