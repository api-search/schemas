...
schema_file: json-schema/well-architected-tool-pillar-id-schema.json
slug: well-architected-tool-pillar-id
source_filename: well-architected-tool-pillar-id-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-well-architected-tool/refs/heads/main/json-schema/well-architected-tool-pillar-id-schema.json
tags:
- Architecture
- Best Practices
- Cloud Governance
