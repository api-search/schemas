...
schema_file: json-schema/events-api-v2-event-ingest-payload-schema.json
slug: events-api-v2-event-ingest-payload
source_filename: events-api-v2-event-ingest-payload-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/dynatrace/refs/heads/main/json-schema/events-api-v2-event-ingest-payload-schema.json
tags:
- AI Operations
- Analytics
- APM
