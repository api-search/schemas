...
schema_file: json-schema/inspector-counts-list-schema.json
slug: inspector-counts-list
source_filename: inspector-counts-list-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-inspector/refs/heads/main/json-schema/inspector-counts-list-schema.json
tags:
- Compliance
- Container Security
- EC2
