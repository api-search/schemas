---
description: GetPlaybackConfigurationResponse schema from Amazon MediaTailor API
layout: schema
...
schema_file: json-schema/mediatailor-api-get-playback-configuration-response-schema.json
slug: mediatailor-api-get-playback-configuration-response
source_filename: mediatailor-api-get-playback-configuration-response-schema.json
source_heading: JSON Schema
source_json: "{\n  \"$schema\": \"https://json-schema.org/draft/2020-12/schema\",\n  \"$id\": \"https://raw.githubusercontent.com/api-evangelist/amazon-mediatailor/refs/heads/main/json-schema/mediatailor-api-get-playback-configuration-response-schema.json\",\n  \"title\": \"GetPlaybackConfigurationResponse\",\n  \"description\": \"GetPlaybackConfigurationResponse schema from Amazon MediaTailor API\",\n  \"type\": \"object\",\n  \"properties\": {\n    \"AdDecisionServerUrl\": {\n      \"allOf\": [\n        {\n          \"$ref\": \"#/components/schemas/__string\"\n        },\n        {\n          \"description\": \"The URL for the ad decision server (ADS). This includes the specification of static parameters and placeholders for dynamic parameters. AWS Elemental MediaTailor substitutes player-specific and session-specific parameters as needed when calling the ADS. Alternately, for testing, you can provide a static VAST URL. The maximum length is 25,000 characters.\"\n        }\n      ]\n \
