...
schema_file: json-schema/user-pools-list-user-pools-response-schema.json
slug: user-pools-list-user-pools-response
source_filename: user-pools-list-user-pools-response-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-cognito/refs/heads/main/json-schema/user-pools-list-user-pools-response-schema.json
tags:
- Authentication
- Identity
- OAuth
