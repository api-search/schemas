...
schema_file: json-schema/user-pools-lambda-config-type-schema.json
slug: user-pools-lambda-config-type
source_filename: user-pools-lambda-config-type-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-cognito/refs/heads/main/json-schema/user-pools-lambda-config-type-schema.json
tags:
- Authentication
- AWS
- Identity
