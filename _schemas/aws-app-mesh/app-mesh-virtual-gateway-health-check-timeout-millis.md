...
schema_file: json-schema/app-mesh-virtual-gateway-health-check-timeout-millis-schema.json
slug: app-mesh-virtual-gateway-health-check-timeout-millis
source_filename: app-mesh-virtual-gateway-health-check-timeout-millis-schema.json
