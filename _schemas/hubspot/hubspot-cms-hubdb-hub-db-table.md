...
source_filename: hubspot-cms-hubdb-hub-db-table-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/hubspot/refs/heads/main/json-schema/hubspot-cms-hubdb-hub-db-table-schema.json
tags:
- Analytics
- Commerce
- Content
