...
schema_file: json-schema/user-pools-start-user-import-job-request-schema.json
slug: user-pools-start-user-import-job-request
source_filename: user-pools-start-user-import-job-request-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-cognito/refs/heads/main/json-schema/user-pools-start-user-import-job-request-schema.json
tags:
- Authentication
- AWS
- Identity
