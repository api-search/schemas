---
description: vehicleSummaries schema
layout: schema
name: vehicleSummaries
properties_list: []
provider_name: Amazon IoT FleetWise
provider_slug: amazon-iot-fleetwise
schema_file: json-schema/iot-fleetwise-vehicle-summaries-schema.json
slug: iot-fleetwise-vehicle-summaries
source_filename: iot-fleetwise-vehicle-summaries-schema.json
source_heading: JSON Schema
source_json: "{\n  \"$schema\": \"https://json-schema.org/draft/2020-12/schema\",\n  \"$id\": \"https://raw.githubusercontent.com/api-evangelist/amazon-iot-fleetwise/refs/heads/main/json-schema/iot-fleetwise-vehicle-summaries-schema.json\",\n  \"title\": \"vehicleSummaries\",\n  \"description\": \"vehicleSummaries schema\",\n  \"type\": \"array\",\n  \"items\": {\n    \"type\": \"object\",\n    \"required\": [\n      \"vehicleName\",\n      \"arn\",\n      \"modelManifestArn\",\n      \"decoderManifestArn\",\n      \"creationTime\",\n      \"lastModificationTime\"\n    ],\n    \"properties\": {\n      \"vehicleName\": {\n        \"allOf\": [\n          {\n            \"$ref\": \"#/components/schemas/vehicleName\"\n          },\n          {\n            \"description\": \"The unique ID of the vehicle.\"\n          }\n        ]\n      },\n      \"arn\": {\n        \"allOf\": [\n          {\n            \"$ref\": \"#/components/schemas/arn\"\n          },\n          {\n            \"description\"\
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-iot-fleetwise/refs/heads/main/json-schema/iot-fleetwise-vehicle-summaries-schema.json
tags:
- Automotive
- AWS
- Connected Vehicles
