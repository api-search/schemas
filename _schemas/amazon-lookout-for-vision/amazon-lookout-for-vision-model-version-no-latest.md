...
layout: schema
name: ModelVersionNoLatest
properties_list: []
provider_name: Amazon Lookout for Vision
provider_slug: amazon-lookout-for-vision
schema_file: json-schema/amazon-lookout-for-vision-model-version-no-latest-schema.json
slug: amazon-lookout-for-vision-model-version-no-latest
source_filename: amazon-lookout-for-vision-model-version-no-latest-schema.json
