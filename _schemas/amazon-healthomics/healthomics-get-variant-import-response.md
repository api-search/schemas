...
schema_file: json-schema/healthomics-get-variant-import-response-schema.json
slug: healthomics-get-variant-import-response
source_filename: healthomics-get-variant-import-response-schema.json
...
source_json: "{\n  \"$schema\": \"https://json-schema.org/draft/2020-12/schema\",\n  \"$id\": \"https://raw.githubusercontent.com/api-evangelist/amazon-healthomics/refs/heads/main/json-schema/healthomics-get-variant-import-response-schema.json\",\n  \"title\": \"GetVariantImportResponse\",\n  \"type\": \"object\",\n  \"required\": [\n    \"id\",\n    \"destinationName\",\n    \"roleArn\",\n    \"status\",\n    \"statusMessage\",\n    \"creationTime\",\n    \"updateTime\",\n    \"items\",\n    \"runLeftNormalization\"\n  ],\n  \"properties\": {\n    \"id\": {\n      \"allOf\": [\n        {\n          \"$ref\": \"#/components/schemas/ResourceId\"\n        },\n        {\n          \"description\": \"The job's ID.\"\n        }\n      ]\n    },\n    \"destinationName\": {\n      \"allOf\": [\n        {\n          \"$ref\": \"#/components/schemas/StoreName\"\n        },\n        {\n          \"description\": \"The job's destination variant store.\"\n        }\n      ]\n    },\n    \"roleArn\"\
  ...
  \ data. \"\n        }\n      ]\n    }\n  }\n}"
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-healthomics/refs/heads/main/json-schema/healthomics-get-variant-import-response-schema.json
tags:
- AWS
- Bioinformatics
- Genomics
