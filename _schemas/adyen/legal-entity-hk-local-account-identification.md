...
provider_name: Adyen
provider_slug: adyen
schema_file: json-schema/legal-entity-hk-local-account-identification-schema.json
slug: legal-entity-hk-local-account-identification
source_filename: legal-entity-hk-local-account-identification-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/adyen/refs/heads/main/json-schema/legal-entity-hk-local-account-identification-schema.json
tags:
- Payments
- Financial Services
- Fintech
