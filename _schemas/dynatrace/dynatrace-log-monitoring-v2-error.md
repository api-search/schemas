...
schema_file: json-schema/dynatrace-log-monitoring-v2-error-schema.json
slug: dynatrace-log-monitoring-v2-error
source_filename: dynatrace-log-monitoring-v2-error-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/dynatrace/refs/heads/main/json-schema/dynatrace-log-monitoring-v2-error-schema.json
tags:
- AI Operations
- Analytics
- APM
