...
provider_name: Adyen
provider_slug: adyen
schema_file: json-schema/configuration-hu-local-account-identification-schema.json
slug: configuration-hu-local-account-identification
source_filename: configuration-hu-local-account-identification-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/adyen/refs/heads/main/json-schema/configuration-hu-local-account-identification-schema.json
tags:
- Payments
- Financial Services
- Fintech
