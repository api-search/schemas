...
schema_file: json-schema/iot-core-create-o-t-a-update-response-schema.json
slug: iot-core-create-o-t-a-update-response
source_filename: iot-core-create-o-t-a-update-response-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-iot-core/refs/heads/main/json-schema/iot-core-create-o-t-a-update-response-schema.json
tags:
- AWS
- Device Management
- IoT
