...
schema_file: json-schema/healthomics-create-reference-store-response-schema.json
slug: healthomics-create-reference-store-response
source_filename: healthomics-create-reference-store-response-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-healthomics/refs/heads/main/json-schema/healthomics-create-reference-store-response-schema.json
tags:
- Bioinformatics
- Genomics
- Healthcare
