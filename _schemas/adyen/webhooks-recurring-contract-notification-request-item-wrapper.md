...
provider_name: Adyen
provider_slug: adyen
schema_file: json-schema/webhooks-recurring-contract-notification-request-item-wrapper-schema.json
slug: webhooks-recurring-contract-notification-request-item-wrapper
source_filename: webhooks-recurring-contract-notification-request-item-wrapper-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/adyen/refs/heads/main/json-schema/webhooks-recurring-contract-notification-request-item-wrapper-schema.json
tags:
- Payments
- Financial Services
- Fintech
