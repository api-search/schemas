...
schema_file: json-schema/cognito-idp-forget-device-request-schema.json
slug: cognito-idp-forget-device-request
source_filename: cognito-idp-forget-device-request-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/aws-cognito/refs/heads/main/json-schema/cognito-idp-forget-device-request-schema.json
tags:
- Authentication
- Authorization
- AWS
