...
schema_file: json-schema/flight-create-orders-location-value-schema.json
slug: flight-create-orders-location-value
source_filename: flight-create-orders-location-value-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amadeus-reservations/refs/heads/main/json-schema/flight-create-orders-location-value-schema.json
tags:
- Booking
- Flights
- Hotels
