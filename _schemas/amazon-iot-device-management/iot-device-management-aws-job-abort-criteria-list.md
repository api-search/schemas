...
schema_file: json-schema/iot-device-management-aws-job-abort-criteria-list-schema.json
slug: iot-device-management-aws-job-abort-criteria-list
source_filename: iot-device-management-aws-job-abort-criteria-list-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-iot-device-management/refs/heads/main/json-schema/iot-device-management-aws-job-abort-criteria-list-schema.json
tags:
- AWS
- Device Management
- Fleet Management
