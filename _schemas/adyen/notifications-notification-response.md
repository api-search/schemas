...
provider_name: Adyen
provider_slug: adyen
schema_file: json-schema/notifications-notification-response-schema.json
slug: notifications-notification-response
source_filename: notifications-notification-response-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/adyen/refs/heads/main/json-schema/notifications-notification-response-schema.json
tags:
- Payments
- Financial Services
- Fintech
