---
description: AccountHolderStatusChangeNotification schema from Adyen API
layout: schema
...
provider_name: Adyen
provider_slug: adyen
schema_file: json-schema/notifications-account-holder-status-change-notification-schema.json
slug: notifications-account-holder-status-change-notification
source_filename: notifications-account-holder-status-change-notification-schema.json
source_heading: JSON Schema
source_json: "{\n  \"$schema\": \"https://json-schema.org/draft/2020-12/schema\",\n  \"$id\": \"https://raw.githubusercontent.com/api-evangelist/adyen/refs/heads/main/json-schema/notifications-account-holder-status-change-notification-schema.json\",\n  \"title\": \"AccountHolderStatusChangeNotification\",\n  \"description\": \"AccountHolderStatusChangeNotification schema from Adyen API\",\n  \"type\": \"object\",\n  \"properties\": {\n    \"content\": {\n      \"description\": \"The details of the Account Holder status change.\",\n      \"$ref\": \"#/components/schemas/AccountHolderStatusChangeNotificationContent\"\n    },\n    \"error\": {\n      \"x-addedInVersion\": \"5\",\n      \"description\": \"Error information of failed request. No value provided here if no error occurred on processing.\",\n      \"$ref\": \"#/components/schemas/NotificationErrorContainer\"\n    },\n    \"eventDate\": {\n      \"x-addedInVersion\": \"4\",\n      \"description\": \"The date and time when an event\
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/adyen/refs/heads/main/json-schema/notifications-account-holder-status-change-notification-schema.json
tags:
- Payments
- Financial Services
- Fintech
