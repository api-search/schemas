---
description: ListWorldExportJobsRequest schema from openapi
layout: schema
name: ListWorldExportJobsRequest
properties_list:
- description: ''
  name: nextToken
  type: object
...
schema_file: json-schema/amazon-robomaker-openapi-list-world-export-jobs-request-schema.json
slug: amazon-robomaker-openapi-list-world-export-jobs-request
source_filename: amazon-robomaker-openapi-list-world-export-jobs-request-schema.json
source_heading: JSON Schema
source_json: "{\n  \"$schema\": \"https://json-schema.org/draft/2020-12/schema\",\n  \"$id\": \"https://raw.githubusercontent.com/api-evangelist/amazon-robomaker/refs/heads/main/json-schema/amazon-robomaker-openapi-list-world-export-jobs-request-schema.json\",\n  \"title\": \"ListWorldExportJobsRequest\",\n  \"description\": \"ListWorldExportJobsRequest schema from openapi\",\n  \"type\": \"object\",\n  \"properties\": {\n    \"nextToken\": {\n      \"allOf\": [\n        {\n          \"$ref\": \"#/components/schemas/PaginationToken\"\n        },\n        {\n          \"description\": \"If the previous paginated request did not return all of the remaining results, the response object's <code>nextToken</code> parameter value is set to a token. To retrieve the next set of results, call <code>ListWorldExportJobs</code> again and assign that token to the request object's <code>nextToken</code> parameter. If there are no remaining results, the previous response object's NextToken parameter is\
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-robomaker/refs/heads/main/json-schema/amazon-robomaker-openapi-list-world-export-jobs-request-schema.json
tags:
- AWS
- Robotics
- Simulation
