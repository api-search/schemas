...
schema_file: json-schema/cognito-idp-admin-update-device-status-request-schema.json
slug: cognito-idp-admin-update-device-status-request
source_filename: cognito-idp-admin-update-device-status-request-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/aws-cognito/refs/heads/main/json-schema/cognito-idp-admin-update-device-status-request-schema.json
tags:
- Authentication
- Authorization
- Identity
