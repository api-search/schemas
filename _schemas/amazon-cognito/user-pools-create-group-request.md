...
schema_file: json-schema/user-pools-create-group-request-schema.json
slug: user-pools-create-group-request
source_filename: user-pools-create-group-request-schema.json
