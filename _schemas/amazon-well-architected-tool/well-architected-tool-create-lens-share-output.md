...
schema_file: json-schema/well-architected-tool-create-lens-share-output-schema.json
slug: well-architected-tool-create-lens-share-output
source_filename: well-architected-tool-create-lens-share-output-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-well-architected-tool/refs/heads/main/json-schema/well-architected-tool-create-lens-share-output-schema.json
tags:
- Architecture
- AWS
- Best Practices
