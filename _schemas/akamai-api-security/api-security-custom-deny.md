...
source_json_url: https://raw.githubusercontent.com/api-evangelist/akamai-api-security/refs/heads/main/json-schema/api-security-custom-deny-schema.json
tags:
- API Discovery
- API Security
- Cloud Security
