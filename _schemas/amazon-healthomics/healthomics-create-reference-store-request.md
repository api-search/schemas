...
schema_file: json-schema/healthomics-create-reference-store-request-schema.json
slug: healthomics-create-reference-store-request
source_filename: healthomics-create-reference-store-request-schema.json
...
source_json_url: https://raw.githubusercontent.com/api-evangelist/amazon-healthomics/refs/heads/main/json-schema/healthomics-create-reference-store-request-schema.json
tags:
- AWS
- Bioinformatics
- Genomics
